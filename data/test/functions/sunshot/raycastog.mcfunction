...
execute positioned ~ ~-0.5 ~ if entity @e[distance=..1.5,type=#minecraft:mobs] if score Range shootgun matches 4.. run scoreboard players set FINISH shootgun 1
execute positioned ~ ~-0.5 ~ if entity @e[distance=..1.5,type=#minecraft:mobs] if score Range shootgun matches 4.. at @s run playsound minecraft:block.note_block.snare master @s ~ ~ ~ 10 2
execute positioned ~ ~-0.5 ~ as @e[distance=..1.5,type=#minecraft:mobs] positioned ~ ~0.25 ~ unless entity @s[distance=..1.3] if score Range shootgun matches 4..30 at @s run scoreboard players set Crit shootgun 1
...
execute positioned ^ ^ ^1 unless score FINISH shootgun matches 1 run function test:sunshot/raycast
execute if score FINISH shootgun matches 1 run scoreboard players operation TEST shootgun = Range shootgun
execute positioned ~ ~-0.5 ~ if score FINISH shootgun matches 1 run function test:sunshot/nocrit
