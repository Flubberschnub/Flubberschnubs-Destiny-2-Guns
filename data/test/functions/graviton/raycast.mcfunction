...
execute positioned ^ ^ ^0.5 unless score FINISH shootgun matches 1 run function test:graviton/raycast
execute if score FINISH shootgun matches 1 run scoreboard players operation TEST shootgun = Range shootgun
execute positioned ~ ~-0.9 ~ if score FINISH shootgun matches 1 unless score Crit shootgun matches 1 run function test:graviton/nocrit
execute positioned ~ ~-0.9 ~ if score FINISH shootgun matches 1 if score Crit shootgun matches 1 run function test:graviton/crit
