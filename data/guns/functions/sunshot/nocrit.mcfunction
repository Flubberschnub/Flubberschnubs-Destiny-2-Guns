...
execute positioned ~ ~ ~ if entity @e[distance=..1,type=#guns:mobs,scores={hp=..12}] if score Range shootgun matches 25.. run scoreboard players set Kill shootgun 1
execute positioned ~ ~ ~ if entity @e[distance=..1,type=#guns:mobs,scores={hp=..24}] if score Range shootgun matches ..24 run scoreboard players set Kill shootgun 1
...
execute as @e[distance=..1,type=#guns:mobs] if score Range shootgun matches 25.. run scoreboard players set @s aestd.damage 1200
...
execute as @e[distance=..1,type=#guns:mobs] if score Range shootgun matches ..24 run scoreboard players set @s aestd.damage 2400
