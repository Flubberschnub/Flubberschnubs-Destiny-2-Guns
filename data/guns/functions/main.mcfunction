...
##shooting
##sunshot
execute as @a[scores={shootgun=1..,magazine=1..},tag=!rpm,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{gun:1,sunshot:1}}}] at @s anchored eyes run function guns:sunshot/shoot
execute as @a[scores={shootgun=1..,magazine=1..},tag=!rpm,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{gun:1,sunshot:2}}}] at @s anchored eyes run function guns:sunshot/shoot
...
##graviton
execute as @a[scores={shootgun=1..,magazine=1..},tag=!rpm,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{gun:1,graviton:1}}}] at @s anchored eyes run function guns:graviton/shoot
...
##sunshot
execute as @a[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{gun:1,sunshot:1}}},tag=!reloading,scores={magazine=4..}] run title @s actionbar [{"score":{"name":"@s","objective":"magazine"},"color":"gold","italic":false},{"text":"/12","color":"dark_gray","italic":false}]
execute as @a[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{gun:1,sunshot:2}}},tag=!reloading,scores={magazine=4..}] run title @s actionbar [{"score":{"name":"@s","objective":"magazine"},"color":"gold","italic":false},{"text":"/12","color":"dark_gray","italic":false}]
execute as @a[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{gun:1,sunshot:1}}},tag=!reloading,scores={magazine=..3}] run title @s actionbar [{"score":{"name":"@s","objective":"magazine"},"color":"dark_red","italic":false},{"text":"/12","color":"dark_gray","italic":false}]
execute as @a[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{gun:1,sunshot:2}}},tag=!reloading,scores={magazine=..3}] run title @s actionbar [{"score":{"name":"@s","objective":"magazine"},"color":"dark_red","italic":false},{"text":"/12","color":"dark_gray","italic":false}]
