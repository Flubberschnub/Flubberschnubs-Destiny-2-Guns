...
execute positioned ~ ~ ~ if entity @e[distance=..1,type=#guns:mobs,scores={hp=..22}] run scoreboard players set Kill shootgun 1
...
execute as @e[distance=..1,type=#guns:mobs] run scoreboard players set @s aestd.damage 2200
