...
##track
execute as @s[scores={Constant=1}] at @s facing entity @e[scores={cosmotarget=1},limit=1,sort=nearest] eyes if block ^ ^ ^0.1 #guns:passthrough run tp @s ^ ^ ^0.3
execute as @s[scores={Constant=2}] at @s facing entity @e[scores={cosmotarget=2},limit=1,sort=nearest] eyes if block ^ ^ ^0.1 #guns:passthrough run tp @s ^ ^ ^0.3
execute as @s[scores={Constant=3}] at @s facing entity @e[scores={cosmotarget=3},limit=1,sort=nearest] eyes if block ^ ^ ^0.1 #guns:passthrough run tp @s ^ ^ ^0.3
execute as @s[scores={Constant=4}] at @s facing entity @e[scores={cosmotarget=4},limit=1,sort=nearest] eyes if block ^ ^ ^0.1 #guns:passthrough run tp @s ^ ^ ^0.3
execute as @s[scores={Constant=5}] at @s facing entity @e[scores={cosmotarget=5},limit=1,sort=nearest] eyes if block ^ ^ ^0.1 #guns:passthrough run tp @s ^ ^ ^0.3
