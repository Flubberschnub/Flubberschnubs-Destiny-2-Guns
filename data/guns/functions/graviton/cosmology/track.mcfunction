...
execute at @s as @e[distance=..20,type=#guns:livingthings,tag=!cosmoimmune] unless score @s cosmotarget matches 0.. run scoreboard players set @s cosmotarget 0
execute as @s[scores={Constant=1}] at @s unless entity @e[scores={cosmotarget=1}] as @e[limit=1,distance=..20,type=#guns:livingthings,tag=!cosmoimmune,scores={cosmotarget=0}] run scoreboard players set @s cosmotarget 1
execute as @s[scores={Constant=2}] at @s unless entity @e[scores={cosmotarget=2}] as @e[limit=1,distance=..20,type=#guns:livingthings,tag=!cosmoimmune,scores={cosmotarget=0}] run scoreboard players set @s cosmotarget 2
execute as @s[scores={Constant=3}] at @s unless entity @e[scores={cosmotarget=3}] as @e[limit=1,distance=..20,type=#guns:livingthings,tag=!cosmoimmune,scores={cosmotarget=0}] run scoreboard players set @s cosmotarget 3
execute as @s[scores={Constant=4}] at @s unless entity @e[scores={cosmotarget=4}] as @e[limit=1,distance=..20,type=#guns:livingthings,tag=!cosmoimmune,scores={cosmotarget=0}] run scoreboard players set @s cosmotarget 4
execute as @s[scores={Constant=5}] at @s unless entity @e[scores={cosmotarget=5}] as @e[limit=1,distance=..20,type=#guns:livingthings,tag=!cosmoimmune,scores={cosmotarget=0}] run scoreboard players set @s cosmotarget 5
...
##didnt find entity
execute at @s[scores={Constant=1},nbt={Age:99}] run scoreboard players reset @e cosmotarget
