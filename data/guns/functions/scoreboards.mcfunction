##scoreboards
scoreboard objectives add shootgun minecraft.used:minecraft.carrot_on_a_stick
scoreboard objectives add ads minecraft.custom:minecraft.sneak_time
scoreboard objectives add Constant dummy
scoreboard objectives add recoiltimer dummy
...
##magazine
scoreboard players set @a magazine 1
