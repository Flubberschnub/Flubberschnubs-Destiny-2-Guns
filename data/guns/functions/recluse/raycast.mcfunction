...
##particles
execute as @s[tag=ads] if score Range shootgun matches 2 at @s anchored eyes run particle dust 0.588 0.122 1.000 0.1 ^ ^-0.04 ^0.1 0.01 0.01 0.01 1 5 normal @s
execute as @s[tag=!ads] if score Range shootgun matches 2 at @s anchored eyes run particle dust 0.588 0.122 1.000 0.1 ^-.01 ^-0.02 ^0.1 0.01 0.01 0.01 1 5 normal @s
execute if score Range shootgun matches 8.. run particle minecraft:mycelium ~ ~ ~ 0 0 0 0 1
execute if score Range shootgun matches 8.. run particle dust 0.588 0.122 1.000 .5 ~ ~ ~ 0 0 0 2 1
execute if score Range shootgun matches 8.. run particle dust 0.165 0.549 0.408 .5 ~ ~ ~ 0 0 0 3 1
...
execute if score Range shootgun matches 75.. run scoreboard players set FINISH shootgun 1
#execute if score FINISH shootgun matches 1 run summon pufferfish
execute positioned ^ ^ ^0.5 unless score FINISH shootgun matches 1 run function guns:recluse/raycast
execute if score FINISH shootgun matches 1 run scoreboard players operation TEST shootgun = Range shootgun
execute positioned ~ ~-0.9 ~ if score FINISH shootgun matches 1 unless score Crit shootgun matches 1 run function guns:recluse/nocrit
execute positioned ~ ~-0.9 ~ if score FINISH shootgun matches 1 if score Crit shootgun matches 1 run function guns:recluse/crit
